...
export default function FirstBuildIntro({
  eyebrow = "First build",
  heading = "Our first prototype, nestled in the woods.",
  body = "Leonaara Camp is our proof of concept, and you can spend the night in it. A complete Leonaara I in Racine in the Eastern Townships (QC), built with the same design, the same materials, and the same builders who'll work on your home.",
    ...
    <section className="relative w-full bg-white py-[50px] text-black md:pb-[90px] md:pt-[100px] xl:py-[100px]">
      <div className="mx-auto w-full max-w-[1920px] px-6">
        <Reveal className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
          <p className="m-0 text-[12px] uppercase text-black md:text-[14px]">{eyebrow}</p>
          <Link
            href={ctaHref}
