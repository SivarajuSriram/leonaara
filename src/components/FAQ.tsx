  ...
  const faqData = [
    {
      ...
      faqs: [
        {
          question: "What is the Base Build System?",
          answer: "Plans tell a builder what to build. The <em>Base Build System</em> delivers the complete picture: construction documents, a curated design package, a certified builder, a fixed price, on-site inspections, and verified performance targets, before a single shovel hits the ground."
        },
        {
          question: "What models are available?",
          answer: "The Base 1 (960 sq ft, 1 sleeping loft) and the Base 1+ (1,200 sq ft, up to 2 bedrooms + 1 sleeping loft). Both are permanent residential homes built on a foundation, to code, on the same high-performance panel system."
        },
        {
          question: "What's a Base-Certified Builder?",
          answer: "In a conventional build, your builder interprets plans on site. A <em>Base-Certified Builder</em> follows a system they've been trained on: complete build-ready documentation, a defined price, no improvisation. Base checks in at key milestones for quality assurance."
        },
        {
          question: "Is there a warranty?",
          answer: "Every Base home is covered by the GCR new home warranty program, mandatory for new residential construction in Québec."
        }
      ]
    },
    {
      ...
      faqs: [
        ...
        {
          question: "How airtight are Base homes?",
        ...
        {
          question: "What windows does Base use?",
        ...
        {
          question: "What is Base's carbon footprint of the building shell?",
          answer: "It's negative. Where a conventional building shell averages +45 kg CO₂/m², Base panels average -42 kg CO₂/m². The building shell is a carbon sink."
        }
      ]
    },
    {
      ...
      faqs: [
        {
          ...
          answer: "Choose your model and design package. You acquire the <em>Base Build System</em>, including: complete plans, specifications, a certified builder, and a defined construction price. A design meeting finalizes your selections, and your builder brings it to life on your land."
        },
        {
        ...
        {
          question: "Does Base build year-round?",
      ...
      faqs: [
        {
          ...
          answer: "The price includes the <em>Base Build System</em> fee and all construction and materials: exterior finishes, high-performance windows, architectural millwork, mechanical systems. No hidden line items. See the full breakdown on the System & Pricing page."
        },
        {
        ...
        },
        {
          ...
          answer: "Yes. A Base home is financed like a conventional new build through your mortgage provider. The defined-price contract and complete specification book make the process straightforward for lenders."
        }
      ]
    },
    {
      ...
      faqs: [
        {
          question: "Where does Base build?",
        ...
        },
        {
          ...
          answer: "Yes. <em>Base Camp</em> is our finished prototype at Beside LAO in Racine, QC, in the Eastern Townships. Book a stay or schedule a walkthrough with us."
        }
      ]
    }
  ];
