...
const raw: { date: string; title: string; img: string; body: Block[]; moreReading?: { text: string; href: string }[] }[] = [
  {
    date: "March 13, 2025",
    title: "The Results Are In: Base Camp Survey Highlights",
    img: "/media/2025/03/Blog-Image-Survey-Results-576x576.jpg",
    body: [
      { type: "p", text: "Good morning, Basecampers." },
      ...
      { type: "h", text: "What Basecampers Had to Say" },
      {
        type: "quote",
      ...
      {
        type: "p",
        text: "Most of you are **couples looking for a secondary residence**, but we also saw a strong interest from families with kids, which was great to see. Another interesting trend? Many of you are thinking about **renting out your Base home**, either as a short-term rental or an additional income.",
      },
      { type: "image", src: "/media/2025/03/Survey-Anwers-Diagrams-04-576x239.jpg", alt: "Who will be the primary occupants of your Base home?" },
      { type: "caption", text: "“WHO WILL BE THE PRIMARY OCCUPANTS OF YOUR BASE HOME?”" },
      { type: "image", src: "/media/2025/03/Survey-Anwers-Diagrams-03-576x215.jpg", alt: "How do you plan to use your Base home?" },
      { type: "caption", text: "“HOW DO YOU PLAN TO USE YOUR BASE HOME?”" },
      ...
      { type: "image", src: "/media/2025/03/Survey-Anwers-Diagrams-09-576x363.jpg", alt: "What features are most important to you in a Base home?" },
      { type: "caption", text: "“WHAT FEATURES ARE MOST IMPORTANT TO YOU IN A BASE HOME?”" },
      ...
      { type: "image", src: "/media/2025/03/Survey-Anwers-Diagrams-06-576x118.jpg", alt: "Do you currently own land where you intend to place a Base home?" },
      { type: "caption", text: "“DO YOU CURRENTLY OWN LAND WHERE YOU INTEND TO PLACE A BASE HOME?”" },
      ...
      {
        type: "p",
        text: "The majority of respondents fall in the $250K-$300K range, which wasn't a surprise, but still good to confirm. While we project that Base I and Base I+ will fall within the 300K-400K range, it's great to understand where you're at as we look to design future models.",
      },
      ...
      { type: "p", text: "Thank you again to everyone who shared their thoughts. If you haven't filled out the survey yet, now's your chance—our Basecamp will really help shape the future of Base." },
      { type: "p", text: "**Take the Survey here !**" },
      { type: "p", text: "Cheerio." },
      { type: "p", text: "—The Base Team 🚀" },
    ],
  },
  {
    ...
    body: [
      ...
      { type: "h", text: "How This Applies to Base" },
      ...
      { type: "p", text: "At Base Habitation, we apply the same principles:" },
      {
        type: "list",
        items: [
  ...
  },
  {
    ...
    body: [
      ...
      { type: "p", text: "Over here at Base Habitation, we know one thing to be true: We are stronger together." },
      { type: "p", text: "We're in the early days of Base Habitation, setting the foundation for something new. But we don't want to do it alone—**we want to build Base with you.**" },
      {
        type: "p",
      ...
      {
        type: "p",
        text: "We created Base to redefine how we build and live—not as a one-time shift, but as an ongoing evolution toward greater flexibility, sustainability, and alignment with your lifestyle.",
      },
      ...
      {
        type: "p",
        text: "That's where **Base Camp** comes in—not just as a name, but as a space for a community of people who believe in better ways of living, building, and designing. People who want to be part of something from the ground up.",
      },
      { type: "p", text: "Send us a message and let us know:" },
      {
        ...
        items: [
          ...
          "**👉 What would you love to see out of Base, moving forward?**",
        ],
      },
      { type: "p", text: "We will reply to every single response." },
      { type: "p", text: "And since you're here, you might want to know a little more about the people behind Base…" },
      ...
      { type: "p", text: "That's why I founded Base—to offer an easy solution for a better way to live." },
      {
        type: "p",
        text: "Outside of Base, I run as much as I can—it clears my mind and fuels ideas. I love to cook, barely drink but love learning about wine, and always need a creative outlet, from sketching to graphic design. The rest of my time? With my partner, B, and our kids, S and L.",
      },
      ...
      { type: "p", text: "— Julien" },
      { type: "p", text: "P.S. If you're not already hanging out with us on Instagram, come say hey: @basehabitation 🪓" },
      { type: "p", text: "As always, thank you for reading and see you next time!" },
    ],
  },
  {
    ...
    body: [
      ...
      { type: "h", text: "3. In what ways do you feel Fab Structures and Base Habitation align in terms of vision and goals?" },
      {
        type: "p",
        text: "Beyond our shared start-up mentality, both Base and Fab focus on improving efficiency and affordability without compromising quality. This mindset led to our collaboration, where we substituted an insulation product with hemp insulation for the first time. We were able to meet performance needs while also pushing for higher sustainability standards. Fortunately, the hemp product was both affordable and recently CCMC-approved.",
      },
      { type: "image", src: "/media/2024/11/P1000958-Small-576x324.jpg", alt: "The Fab team assemble a Base Habitation wall panel" },
      { type: "caption", text: "THE FAB TEAM ASSEMBLE A BASE HABITATION WALL PANEL" },
      ...
      {
        type: "p",
        text: "Our combined focus on design for manufacturing is transformative. By “productizing” builds, we can reduce waste, lower costs, and normalize higher-quality materials like hemp insulation and advanced membranes. Base Habitation excels at designing for scalability, optimizing prefabrication, and promoting sustainable materials—setting a benchmark for others to follow.",
      },
      { type: "image", src: "/media/2024/11/P1000938-Small-576x324.jpg", alt: "The Base I+ roof panels, ready to go" },
      { type: "caption", text: "THE BASE I+ ROOF PANELS, READY TO GO" },
  ...
  },
  {
    ...
    body: [
      {
        type: "p",
        text: "The cottage has evolved. Some Base homes will serve as a secondary residence—the modern cottage for today's generation of homebuyers. But the ‘cottage' has the potential to be so much more. Its very notion needs to be redefined.",
      },
      { type: "p", text: "That's why we're creating a simpler and more accessible alternative by building it better and faster, and by future-proofing it with our Base Ecosystem." },
      { type: "p", text: "Here are **6 ways** Base is redefining the cottage:" },
      ...
      {
        type: "p",
        text: "At Base, our homes are designed to grow with you. Need a personal studio, a space for guests, or room for a future greenhouse? Our designs allow you to expand your home as your dreams – and your budget – evolve.",
      },
  ...
  },
  {
    ...
    body: [
      ...
      { type: "image", src: "/media/2024/09/201B-04-576x430.jpg", alt: "The functional block in the Base I" },
      { type: "caption", text: "THE FUNCTIONAL BLOCK IN THE BASE I" },
      {
        type: "p",
        text: "At the core of every Base home, is its compact functional block – a cube that holds all of the home's important functional elements: the kitchen, the mezzanine bedroom, the bathroom and the mechanical room. By efficiently grouping these together, we can maximize the rest of the open living space for you while also simplifying the construction.",
      },
      ...
      { type: "p", text: "All in all, these are the elements that make up the core of our home design: the functional block. Catch the next baseletter as we continue to explore the many aspects of the Base Ecosystem." },
      { type: "p", text: "As always, thank you for reading and see you next time!" },
    ],
  },
  {
    ...
    body: [
      ...
      {
        type: "p",
        text: "Our homes were designed around ideas of robust simplicity and compactness – trimming away the excess to be left with the simplest expression of the home. This is what drives the Base mission, to do less, better.",
      },
      ...
      { type: "h", text: "Base Design" },
      {
        type: "p",
        text: "The BASE I has two main elements: the functional block (red) and the living space (beige). By condensing all the functional elements (kitchen, bathroom, bedroom and mechanical room) into one block, we can leave the rest of the space uninterrupted for open living. Our BASE I+ model follows the same logic on a slightly larger scale.",
      },
  ...
  },
  {
    ...
    body: [
      ...
      {
        type: "p",
        text: "This is why Base emphasizes high-performance design using almost exclusively natural or biogenic materials, resulting in a carbon-neutral assembly – a new generation of prefabrication. But what does carbon neutrality really mean, and why should your home be built this way?",
      },
  ...
  },
  {
    ...
    body: [
      { type: "p", text: "The first sketches of our signature model, the Base I, date all the way back to 2017!" },
      {
        type: "p",
      ...
      { type: "image", src: "/media/2024/05/a5987f60-5e91-c1cf-e1a8-ec9f6994d30c-576x384.jpg", alt: "Early sketches from Base I layouts, 2017" },
      { type: "caption", text: "SOME EARLY SKETCHES FROM BASE I LAYOUTS FROM 2017." },
      {
        type: "p",
      ...
      {
        type: "p",
        text: "Early on, we started dreaming of an entire product line to address these issues, but we had to start small and build our way up. That's when the Base I series was designed – the dream cabin in the woods coupled with turnkey sustainability. Infusing it with an innovative prefab approach, climate-resilient materials and local artisanship, would enable us to drive more impact and create an original offering.",
      },
      {
        type: "p",
        text: "Our vision of a larger product line eventually turned into the Base Ecosystem: a sustainability toolkit of sorts, with building blocks to pick and chose from to assemble your dream project on land of your own. It's what we're building towards everyday.",
      },
      {
        type: "p",
        text: "The final thing we needed was a name. It didn't take long to land on Base. Simple and to the point, it reminded us of the importance of building a strong foundation, of having a refuge to keep you safe, of getting back to basics.",
      },
    ],
  },
];
